...
These sensor boards were built to read and display thermometry data. They were orignialy used for an experiment made by LUX-ZEPPLIN (LZ) to measure data within their cryogenic systems. Later, a group from the nEXO group based their design (with permission) off of the group from LZ. 

This document details the process of parts, construction, set-up, and uses of these boards for the nEXO experiment at the SLAC National Accelerator Laboratory. The boards at nEXO are used for cryogenic purposes inside of a cryogenic distillation column. 

**Please don't hesitate to contact me with any questions you may have!!**


The Thermometry Boards are able to detect temperature, pressure, and humidity using five Adafruit MAX31865, two MAX31856 boards (Thermocouple Amplifires), and one BME 280.

The pads are soldered to a small .5" circuit board and connected to the main Thermo board through a series of cables (which will be detailed out below). The small PT100 boards contain a 4-40 sized hole for a small screw, which will allow the boards to be attached to specific places inside of the cryogenic system (more into this later). 
